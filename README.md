...
You can then execute your native executable with: `./target/kb-joperator-1.0-SNAPSHOT-runner`
...
- Mutiny ([guide](https://quarkus.io/guides/mutiny-primer)): Write reactive applications with the
  modern Reactive Programming library Mutiny
